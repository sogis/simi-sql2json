...
public class TemplateWalkerTest {
    ...
    void withoutTag_Identical_OK() throws Exception {
        ...
        try {
            TemplateWalker.walkTemplate(template, new TextOutput(OutputFormat.JSON, output));
    ...
    void mixedTags_WithErrors_WritesToEnd() throws Exception {
        ...
        assertThrows(AggregateException.class, () -> {TemplateWalker.walkTemplate(template, new TextOutput(OutputFormat.JSON, output));});
